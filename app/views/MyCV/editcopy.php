                        ...
                        <?php foreach ($education as $edu): ?>
                            <div class="card-body pt-none" id="education-form">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="edu-schoolname[]"
                                        placeholder="Đại học abc" value="<?= htmlspecialchars($edu['school'] ?? '') ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="dropdown-container">
                                        <button type="button" class="dropdown-btn form-control">Chọn chuyên ngành</button>
                                        <input type="hidden" name="edu-major[]"
                                            value="<?= htmlspecialchars($edu['major'] ?? '') ?>">
                                        <!-- Dropdown content -->
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-none" id="award-form">
                            ...
                            <?php foreach ($awards as $award): ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="award-decription" name="award-decription[]"
                                        placeholder="Mô tả"><?= htmlspecialchars($award['description'] ?? (isset($_POST['award-decription'][$awardIndex]) ? $_POST['award-decription'][$awardIndex] : '')); ?>
                                    </textarea>
                                </div>
                            ...
                            <?php if (empty($awards)): ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="award-decription"
                                        name="award-decription[]" placeholder="Mô tả"
                                        value="<?= htmlspecialchars(isset($_POST['award-decription'][0]) ? $_POST['award-decription'][0] : ''); ?>"></textarea>
                                </div>
                                <button type="button" class="btn btn-danger btn-sm float-right btn-award">Xóa</button>
                            <?php endif; ?>
                        </div>
